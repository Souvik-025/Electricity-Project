...
public class CommonService {
	...
	public Map<String, Object> getAllCustomers() {
		...
		List<CustomerQueryContactResponseDTO> collect = queryContactRepository.findAll().stream()
	...
	public Map<String, Object> saveQuery(CustomerQueryContactRequestDTO dto) {
		...
		queryContactRepository.save(contact);

		Map<String, Object> response = new HashMap<>();
		response.put("res", true);
		response.put("message", "Customer contact submitted successfully");
